function [MTH_FV_UsingCanny] = Canny_36_getImageTextonFeature(imageName)
...
[theta]            = Canny_36_OrientationDetection(1.4, imageName, 60, 40);%OrientationDetection(RGB, Rows, Columns);
