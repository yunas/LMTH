function [MTH_FV_UsingCanny] = Canny_18_getImageTextonFeature(imageName)
...
[theta]            = Canny_18_OrientationDetection(1.4, imageName, 60, 40);%OrientationDetection(RGB, Rows, Columns);
...
MTH_FV_UsingCanny = zeros(CSA+CSB,1);

for i=1: CSA+CSB
    
    MTH_FV_UsingCanny(i)=(MatrixH(i)+MatrixV(i)+MatrixRD(i)+MatrixLD(i))/4.0;
